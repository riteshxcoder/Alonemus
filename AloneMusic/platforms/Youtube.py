...
class YouTubeAPI:
    ...
    async def details(self, link: str, videoid: Union[bool, str] = None):
        ...
        if data:
            # Trigger prefetch of the stream URL as soon as details are requested (likely for queueing)
            asyncio.create_task(self.prefetch(link))
